    ...
    <div class="single_post">
      <header> 
        ...
        <div class="post-info"><span class="theauthor">
          ...
          </span> | <span class="thecategory">
          <?php the_category(', ') ?>
          </span><!-- | <span class="thecomment"><a href="<?php comments_link(); ?>"><?php comments_number();?></a></span>--></div>
        <!-- End Post Meta --> 
      </header>
      <!-- Start Content -->
      <div class="post-single-content box mark-links">
        ...
        <div class="topad"> <?php echo $mts_options['mts_posttop_adcode']; ?> </div>
        <?php } ?>
        <?php } ?>
        <?php the_content(); ?>
        ...
        <div class="share-wrapper">
          <div class="share-inner-wrapper"> <img width="70" height="120" class="post-bot-fb-f" src="<?php bloginfo('stylesheet_directory'); ?>/images/facebook.png"><span class="post-bot-fb-text">喜歡這篇嗎？快分享！</span> </div>
        </div>
        </a> 
        <!--Facebook Like-->
        <center>
          <span style="margin-top:2em;">請幫我們按個贊吧！</span>
          <div class="fb-like" data-href="https://www.facebook.com/pages/&#x7231;&#x5947;&#x95fb;-i7wencom/399615256870590" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false" style="margin-top:0.5em;"></div>
        </center>
        <!--Facebook Like End-->
        <?php } //RLEE Facebook ?>
        ...
        <div class="bottomad"> <?php echo $mts_options['mts_postend_adcode'];?> </div>
        <?php } ?>
        <?php } ?>
        <?php if($mts_options['mts_tags'] == '1') { ?>
        <!-- Start Tags -->
        <div class="tags">
          <?php the_tags('<span class="tagtext">'.__('Tags','mythemeshop').':</span>',', ') ?>
        </div>
        <!-- End Tags -->
        <?php } ?>
      </div>
...
$pexcerpt=1; $j = 0; $counter = 0; while( $my_query->have_posts() ) { ++$counter; if($counter == 4) { $postclass = 'last'; $counter = 0; } else { $postclass = ''; } $my_query->the_post();?>
      <li class="<?php echo $postclass; ?> rpexcerpt<?php echo $pexcerpt ?> <?php echo (++$j % 2 == 0) ? 'last' : ''; ?>">
        ...
        <a rel="nofollow" class="relatedthumb" href="http://vossbox.com/blog.html?ref=i7wen" rel="bookmark" title="想在這裡看到你的内容?"> <span class="rthumb"> <img width="140" height="100" src="http://i7wen.com/wp/wp-content/uploads/2015/02/pkxuan.jpg" class="attachment-smallthumb wp-post-image" alt="" title="" /></span> <span>想在這裡看到你的内容?</span> </a>
        <?php else: ?>
      ...
      <div class="postauthor-container">
        <h4>
          <?php _e('About The Author', 'mythemeshop'); ?>
        </h4>
